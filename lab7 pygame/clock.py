...
def game():
    while True:
        ...
        lefthand_scaled = pygame.transform.scale(lefthand, (400, 400))
        theta =  second * (360 / 60) #(minute + second / 60) * (360 / 60)
        screen.blit(lefthand_scaled, convert_degrees_to_pygame(300, theta))

        
        """R = 300
        theta2 = second * (360 / 60)
        pygame.draw.line(screen, (255, 0, 0), (400, 400), convert_degrees_to_pygame(R, theta2), 3)"""
        ...
        rigththand_scaled = pygame.transform.scale(righthand, (400, 400))
        theta = (hour + minute / 60 + second / 360) * (360 / 12)
        screen.blit(rigththand_scaled, convert_degrees_to_pygame(250, theta))
